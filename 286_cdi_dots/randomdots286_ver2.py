...
class Patterns:
  ...
  constant_distortion    -- amount of distortion for individual items
  distortion_per_item    -- distortion defined according to prototypicality of each item 
  """
  def __init__(self, categories = None, levels_of_distortion = None, items_per_level = None, items_per_category = None,
               ...
               patterns = None, prototypes = None, include_prototypes = True, constant_distortion= 1, distortion_per_item = None ): 
    ...
    self.distortion_per_item = np.asarray(distortion_per_item)
  ...
  def create_patterns(self):
    ...
    for i in range(0, self.categories):
      ...
      for l in range(self.levels_of_distortion):
        for e in range(items):
            ...
            distortion = self.distortion_per_item[o]
    ...
    ' not',
    		' same',
    		' some '];
            self.labels.append(zzz[o]+'_'+str(distortion))
